...
public class QueryServiceDynamicSQLTest1 {

	@Inject
	QueryServiceDynamicSQLTest queryService;
	...
	public void testDynamicQueryUsingPagination() {
		...
		List<Map<String,Object>> results = (List) rtMap.get(QueryServiceDynamicSQLTest.LIST);
		Long intVal = (Long) rtMap.get(QueryServiceDynamicSQLTest.COUNT);
